...
| — | Instruksi videoPrompt diperkaya — bahasa DoP/sinematografi | **SELESAI PENUH** | masterPrompt.ts: instruksi videoPrompt diperluas wajib sertakan shot size+angle+movement+lens+focus+lighting (rumus DoP profesional). Terverifikasi 6 scene: semua sertakan shot size+lens+focus+lighting, 5/6 sertakan angle eksplisit. Kualitas naik drastis dari instruksi generik lama ("gerakan kamera, durasi action, transisi"). |
| — | Instruksi imagePrompt diperkaya — bahasa fotografi/sinematografi | **SELESAI** | masterPrompt.ts: imagePrompt diperluas wajib sertakan shot size+angle+lens+composition+DoF+lighting+warna (7 elemen), plus larangan istilah gerakan kamera. Terverifikasi 6 scene: 6/6 shot size+angle+lens+DoF+lighting+warna, 5/6 composition eksplisit, 0/6 mengandung gerakan kamera. |
