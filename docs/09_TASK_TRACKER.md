...
| T0.6 | Setup Jamendo + Freesound client | **SELESAI** | lib/music/jamendo.ts + lib/music/freesound.ts + lib/actions/music.ts. Filter lisensi CC0/CC-BY/CC-BY-SA (tolak NC/ND). Terverifikasi: Freesound "whoosh transition" → 6/20 aman. Jamendo "upbeat corporate" → 0/20 aman (95% BY-NC-ND). |
